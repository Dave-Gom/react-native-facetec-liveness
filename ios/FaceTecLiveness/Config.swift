...
class Config {
    ...
    public static func retrieveConfigurationWizardCustomization() -> FaceTecCustomization {
        ...
        let ovalColor = UIColor(hexString: "#f5f5f5")
        let dualSpinnerColor = UIColor(hexString: "#ffffff")
        let textColor = UIColor(hexString: "#fcfdfd")
        let buttonAndFeedbackBarColor =  UIColor(hexString: "#519dbd")
        let buttonAndFeedbackBarTextColor = UIColor(hexString: "#ffffff")
        let buttonColorHighlight =  UIColor(hexString: "#f7f7f8")
        let buttonColorDisabled =  UIColor(hexString: "#fcfcfc")
